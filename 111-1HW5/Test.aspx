...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="gd_View" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
